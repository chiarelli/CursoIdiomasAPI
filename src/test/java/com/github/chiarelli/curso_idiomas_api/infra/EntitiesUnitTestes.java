...
import com.github.chiarelli.curso_idiomas_api.escola.infra.persistence.AlunoEntity;
...
public class EntitiesUnitTestes {
  ...
  void alunoEntitySalvarComDadosInvalidos() {
    ...
    var alunoOK = new AlunoEntity(alunoId, "Aluno 1", "166.723.870-13", "8f6wZ@example.com");
    assertDoesNotThrow(() -> alunoRepository.save(alunoOK));

    // Tentar salvar aluno mesmo CPF
    var alunoInvalid = new AlunoEntity(UUID.randomUUID(), "Aluno 2", "166.723.870-13", "782tE@example.com");
    ...
    var alunoInvalid2 = new AlunoEntity(UUID.randomUUID(), "Aluno 3", "400.626.040-74", "8f6wZ@example.com");
